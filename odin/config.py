...
def add_maskformer2_video_config(cfg):
    ...
    cfg.EXPORT_BACKBONE_FEATURES = False
    cfg.MODEL.DECODER_PANET = False
    cfg.SCANNET_DATA_DIR = "/mnt/ssd/liuchao/odin/scannet/train_validation_database.yaml"
    cfg.S3DIS_DATA_DIR = "/mnt/ssd/liuchao/odin/s3dis/train_validation_database.yaml"
